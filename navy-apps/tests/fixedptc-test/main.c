...
int main() {
  ...
  printf("The biggest number(NaN): "); fixedpt_printn(0x7fffffff);// 最大数,包括小数
  ...
  printf("FIXEDPT_ONE: "); fixedpt_printn(FIXEDPT_ONE);
  printf("3.1415926 * FIXEDPT_ONE: ");  fixedpt_printn(3.1415926 * FIXEDPT_ONE);
  printf("(-6) * FIXEDPT_ONE: ");  fixedpt_printn((-6) * FIXEDPT_ONE);
  puts("");
