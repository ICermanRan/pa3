...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , seg_0{vlSymsp->TOP.seg_0}
    , seg_1{vlSymsp->TOP.seg_1}
    , seg_2{vlSymsp->TOP.seg_2}
    , seg_3{vlSymsp->TOP.seg_3}
    , seg_4{vlSymsp->TOP.seg_4}
    , seg_5{vlSymsp->TOP.seg_5}
    , rootp{&(vlSymsp->TOP)}
{
}
...
static void _eval_initial_loop(Vtop__Syms* __restrict vlSymsp) {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/ran/ysyx/ysyx-workbench/npc/shiyan/ps2_keyboard/vsrc/top.v", 1, "",
